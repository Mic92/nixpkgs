  ...
  gnomeExtensions = lib.trivial.pipe (gnome47Extensions // gnome48Extensions // gnome49Extensions) [
    ...
    (
      ...
      // lib.optionalAttrs config.allowAliases {
        ...
        pidgin-im-integration = throw "gnomeExtensions.pidgin-im-integration has been removed due to being broken for more than a year; see RFC 180"; # Added 2026-02-05
        ...
        window-corner-preview = throw "gnomeExtensions.window-corner-preview has been removed due to being broken for more than a year; see RFC 180"; # Added 2026-02-05
      }
    )
