{ pkgsMusl, fetchFromGitHub, lib }:

pkgsMusl.rustPlatform.buildRustPackage rec {
  pname = "firecracker";
  version = "0.25.2";
  ...
  src = fetchFromGitHub {
    ...
    repo = "firecracker";
    rev = "v${version}";
    sha256 = "sha256-HoOfltEiUEOTMhVAT5ZmFUNV0qSNS/C303NUu8Y3HuI=";
  };

  cargoHash = "sha256-IIu4ZKD2HLdfGlJooYOgrLiY1xDj+rC2r1XuYECGu5w=";
