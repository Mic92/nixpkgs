...
nameDrvAfterAttrName (
  {
    ...
    # Test that fortify works correctly with different optimization levels
    # Fortify should not be applied with -O0
    fortifyWithO0 = checkTestBin
      (f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-O0";
    ...
    # Fortify should be applied with -O1
    fortifyWithO1 = checkTestBin
      (f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-O1";
    ...
    # Fortify should be applied with -O2
    fortifyWithO2 = checkTestBin
      (f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-O2";
    ...
    # Fortify should be applied with -Os
    fortifyWithOs = checkTestBin
      (f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-Os";
    ...
    # No fortify protection expected with -O0
    fortifyO0NoProtection = fortifyExecTestFull false "0123456 7" "01234567 7" (
      f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-O0";
    ...
    # Fortify protection expected with -O2
    fortifyO2Protection = fortifyExecTest (
      f1exampleWithStdEnv stdenv {
        hardeningEnable = [ "fortify" ];
        env = {
          TEST_EXTRA_FLAGS = "-O2";
